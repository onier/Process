...
Bound EventShape::getBound() {
    return _bound;
}

void EventShape::paint(QPainter *painter) {
...
void EventShape::paintShadow(QPainter *painter) {
    auto pb = painter->brush();
    auto pp = painter->pen();
    if (_isSelected) {
...
void EventShape::paintAnchorPoints(QPainter *painter) {
...
void EventShape::paintControllPoints(QPainter *painter) {
    if (_isSelected) {
...
std::vector<QPointF> EventShape::getAnchorPoints() {
...
std::vector<QPointF> EventShape::getControlPoints() {
...
void EventShape::paintAxis(QPainter *painter) {

}

void EventShape::setBound(Bound rectF) {
    _bound = rectF;
}

void EventShape::transform(float x, float y) {

}

bool EventShape::getNearestAnchor(QPointF point, QPointF &value) {
...
ActionType EventShape::checkActionAnchor(QPointF point, QPointF &target, double value) {
    auto as = getAnchorPoints();
    for (auto &a: as) {
...
bool EventShape::isContained(QPointF pointF) {
